  ...
  'inline-flex items-center gap-1 border px-2 py-0.5 text-2xs font-medium uppercase tracking-wider2',
  {
    variants: {
      variant: {
        ...
        gold: 'border-transparent bg-champagne-soft text-gold-deep',
        positive: 'border-transparent bg-blush/60 text-ink-soft',
        warning: 'border-gold/40 bg-transparent text-gold-deep',
